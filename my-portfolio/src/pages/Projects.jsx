...
const projects = [
  ...
  { id:9, caseStudy:'farming', title:'Farming',          subtitle:'低多边形农场建造 RPG · 系统搭建阶段',     category:'Personal Projects', type:['Game'],     tags:['Unity','C#','Game Design'],        desc:'A Unity 3D low-poly farming RPG (Phase 1 — systems architecture).', images:[], color:'#66cc44', links:{github:'https://github.com/Jt4936/Farming-'}, year:'2025', role:'Game Developer' },
