...
const projects = [
  { id:'time-garden', caseStudy:'time-garden', title:'他年灯下 Time Garden', subtitle:'A third-person puzzle journey across five ages', category:'Personal Projects', type:['Game'], tags:['Unreal Engine 5.7','Windows','Time Puzzles'], desc:'A personally led, AI-assisted narrative puzzle demo. Explore a tortoise-borne courtyard across five ages, follow clues and change the past to open a path home.', images:['/games/time-garden/title-scroll.webp'], color:'#dfbd7c', links:{}, year:'2026', role:'Creator / Design & Development Direction' },
  { id:'slot-kingdom', caseStudy:'slot-kingdom', title:'老虎机王国 Slot Kingdom', subtitle:'City-builder strategy prototype', category:'Personal Projects', type:['Game'], tags:['Unity 6','WebGL','City Builder','Strategy'], desc:'A browser-playable prototype where slot-machine recruitment powers a city economy, army growth and a complete tutorial siege.', images:['/games/slot-kingdom/cover.webp'], color:'#e0a43a', links:{demo:'https://jt4936.itch.io/slot-kingdom-demo'}, year:'2026', role:'Game Designer / Developer' },
  { id:'abyss', caseStudy:'abyss', title:'有尽深渊 Abyss of Ends', subtitle:'Roguelite · 系统 / 数值设计', category:'Personal Projects', type:['Game'], tags:['Unity 6','Roguelite','数值平衡'], desc:'GMTK Game Jam 2026 · 84 小时独立完成的 Roguelite，深度系统与数值设计。', images:['/games/abyss/shot-30.jpg'], color:'#c8f04a', links:{demo:'https://jt4936.itch.io/abyss-of-ends'}, year:'2026', role:'独立开发' },
  { id:'zhongkui', caseStudy:'zhongkui', title:'钟馗传 · 第二章方案', subtitle:'设计拆解 + GDD 方案', category:'Personal Projects', type:['Game'], tags:['游戏策划','拆解','GDD'], desc:'对已上线动作 RPG《钟馗传》第一章的深度拆解，并以标准 GDD 格式提出第二章设计方案。', images:[], color:'#ff5533', links:{}, year:'2026', role:'游戏策划' },
  { id:'mecha', caseStudy:'mecha', title:'回响 ECHO', subtitle:'UE5 科幻 CG 短片', category:'Personal Projects', type:['Game'], tags:['Unreal Engine 5','CG','叙事'], desc:'用 Unreal Engine 5 独立完成的科幻 CG 短片，讲述两个机械生命的故事。', images:['/games/mecha/shot-1.jpg'], color:'#44ddff', links:{}, year:'2025', role:'CG / 场景 / 镜头' },
  ...
  { id:9, caseStudy:'farming', title:'Farming',          subtitle:'低多边形农场建造 RPG · 系统搭建阶段',     category:'Personal Projects', type:['Game'],     tags:['Unity','C#','Game Design'],        desc:'A Unity 3D low-poly farming RPG (Phase 1 — systems architecture).', images:['/games/farming/growth.jpg','/games/farming/shop.jpg'], color:'#66cc44', links:{github:'https://github.com/Jt4936/Farming-'}, year:'2025', role:'Game Developer' },
  { id:11, title:'ODD JOBS: Full Bloom!', subtitle:'2D Florist Simulation Game',      category:'UTS Projects',      type:['Game'],     tags:['Unity','2D','Game Design Studio'], desc:'A fast-paced 2D simulation game where you juggle quirky part-time jobs to earn rent. Play as a florist — serve customers, remember orders, water and pick flowers, trim stems. Playable in browser!', images:['/projects/oddjobs.png'], video:'/games/oddjobs/demo.mp4', poster:'/games/oddjobs/poster.jpg', color:'#44cc88', links:{demo:'https://alf-uts.itch.io/odd-jobs'}, year:'2026', role:'Game Developer' },
  { id:10, title:'RescuSub',         subtitle:'Underwater Rescue Game',          category:'Personal Projects', type:['Game'],     tags:['Unity','C#','Team Project'],       desc:'A Unity underwater rescue game featuring shark enemy AI, oxygen management system, and dynamic hazards. Built as a 4-person team collaboration with custom shaders and UI.', images:['/projects/rescusub.png'], video:'/games/rescusub/demo.mp4', poster:'/games/rescusub/poster.jpg', color:'#00aadd', links:{}, year:'2025', role:'Game Developer' },
        ...
        {selected && (
          ...
          >
            ...
            >
              ...
              {selected.video && (
                <video className="modal-video" src={selected.video} poster={selected.poster}
                  controls preload="none" playsInline />
              )}
              {!selected.video && selected.images.length > 0 && (
